...
The goal of [SPD](https://github.com/orca-scan/simplified-product-data) is to provide the above information to the developer in the first request. Additional, more indepth information such as ingredients can be obtained by following the related HATEOAS link [`gs1:ingredientsInfo`](https://www.gs1.org/voc/ingredientsInfo) in the `links` array.
