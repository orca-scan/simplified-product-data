...
For example this [GS1 Digital Link homepage](https://orca.link/01/05065016432004) returns [example.json](example.json) when requested using `Accept: application/json`:
...
The goal of this data structure is to provide key information to the developer in the first request to the Digital Link URL, eliminating the above issues.
