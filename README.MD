...
The goal of [SPD](https://github.com/orca-scan/simplified-product-data) is to provide key information to the developer in the first request to the Digital Link URL, eliminating the above issues.
